...
<input type="checkbox" id="check">
    ...
    <h3 style="display: inline-block; margin-left: 10px; margin-bottom:auto; vertical-align: middle;">
        <span style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;color:black;">Society</span><span style="font-family: 'Merienda', cursive; color: rgb(20, 80, 32);">HUB</span>
    </h3>
</div>
...
if(isset($_POST['ppaymnet'])){
    ...
    $query = "insert into payment values(null,'$_POST[ptitle]','$_POST[pflat]','$_POST[pamount]','Success')";
